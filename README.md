...
| `LEMLIST_API_KEY` | lemlist API key — optional; enables "Send to lemlist" in the share panel (pushes the proposal link onto a campaign lead as `{{proposalUrl}}`). No-op if unset |
